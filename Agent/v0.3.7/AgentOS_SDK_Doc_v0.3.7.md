# AgentOS SDK for APK V0.3.7 Documentation
...
```Groovy
dependencies {
        implementation 'com.orionstar.agent:sdk:0.3.7-SNAPSHOT' // IMPORTANT: Agent SDK dependency
...
Wake word mode is a new voice interaction control feature in AgentOS SDK v0.3.7, providing more flexible listening trigger mechanisms. Through three core interfaces, developers can precisely control wake word-based voice interaction behavior, adapting to interaction requirements in different scenarios.
